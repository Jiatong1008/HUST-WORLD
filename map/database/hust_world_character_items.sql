...
CREATE TABLE `character_items` (
  ...
  KEY `idx_character_items_character_id` (`character_id`),
  KEY `idx_character_items_item_id` (`item_id`),
  CONSTRAINT `character_items_ibfk_1` FOREIGN KEY (`character_id`) REFERENCES `characters` (`character_id`),
  CONSTRAINT `character_items_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`)
