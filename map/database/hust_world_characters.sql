...
CREATE TABLE `characters` (
  ...
  `game_progress` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`character_id`),
  KEY `idx_characters_user_id` (`user_id`),
  KEY `idx_characters_college` (`college`),
...
INSERT INTO `characters` VALUES (1,1,'测试角色','male','计算机学院',1,0,1500,50,50,NULL,'2026-05-16 03:40:15');
